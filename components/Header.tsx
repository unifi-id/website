  ...
  const navLinks: NavLink[] = useMemo(() => [
    ...
    },
    {
      ...
      children: [
        ...
        { href: '/energy/monitoring/energy-clamp-meters', label: 'Energy Clamp Meters' },
        { href: '/energy/certificates/non-domestic-epc', label: 'Non-Domestic EPCs' },
        {
          href: '/energy/certificates/display-energy-certificates',
          label: 'Display Energy Certificates',
        },
